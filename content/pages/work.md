...
accordion:
  ...
  - applyLink: 'https://www.seek.com.au/job/51290185'
    description: "**ABOUT US\r**\n\nHealthcare Logic is one of Queensland’s fastest growing technology start-ups, and we are aiming for global market leadership within the next five years. We build software to help hospitals work better.  \r\n\nWe are fully funded and currently transacting in five jurisdictions. Our flagship product is SystemView: a new-to-the-world analytics platform using high-frequency data automation and a proprietary UI to give clinical and executive leaders in hospitals previously unobtainable insights and actionable data.  \r\n\n**ABOUT THE ROLE\r**\n\nThe newly created Service Desk Analyst role sits within Healthcare Logic’s Quality team alongside the Test Analysts. We are kind, flexible and great communicators eager to support others. We work alongside data engineers, web engineers and the customer success team (who support our end-users).\r\n\nWe are looking for a committed and motivated individual to join us at an exciting time of rapid expansion. If you are a passionate Service Desk Analyst and are ready for your next challenge, this role is for you.\r\n\nThe Service Desk Analyst will report to the Director of Quality and will primarily engage with internal employees.\r\n\n**Key tasks will include:\r**\n\n* First port of call for any hardware issues & liaising with our IT provider to resolve these\r\n* Managing our M365 instance\r\n* Managing application access\r\n* Managing our network\r\n* Following up and reporting on our production monitoring tools\r\n* Following up internally on issues raised by our customer success team\r\n* Implementing technical cyber security measures\r\n* Helping out the test team with release and regression testing if required\r\n\n**SKILLS WE ARE LOOKING FOR\r**\n\nThese skills and experience will help get you onto the shortlist:\r\n\n* Previous experience as a Service Desk Analyst\r\n* M365 management (Outlook, Exchange, Azure,… )\r\n* Network, Firewall and VPN management\r\n* Experience with ticketing systems\r\n\n **JOB BENEFITS AND PERKS\r**\n\n* Join a team at the cutting edge of Healthcare analytics to improve patient outcomes worldwide\r\n* Full-time – permanent contract (38 hours per week, Mon-Fri)\r\n* A modern office space with awesome views \r\n* Opportunity for promotion as the company grows and your performance exceeds expectations"
