...
export class AnnouncementsPageTemplate extends React.Component {
  render() {
...
const AnnouncementsPage = ({ data: { page } }) => (
  <AnnouncementsPageTemplate {...page} {...page.frontmatter} body={page.html} />
)
