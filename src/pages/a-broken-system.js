  ...
  <main>
    <section className="section dark thick">
      <div className="container">
        ...
        <p>
          Health services across the world are paying huge money to collect vast
          amounts of data but still can’t answer basic questions about what is
          happening inside their hospitals right now and what needs to change to
